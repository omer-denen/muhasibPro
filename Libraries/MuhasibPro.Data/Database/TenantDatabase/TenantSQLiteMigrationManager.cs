    ...
    public class TenantSQLiteMigrationManager : ITenantSQLiteMigrationManager
    {
            ...
            try
            {
                ...
                try
                {
                    ...
                    using var _dbContext = _dbContextFactory.CreateDbContext(
                        databaseName, commandTimeoutSec);
                    var migrationResult = await _dbContext.ExecuteTenantMigrationsWithBackupCheckAsync(
                        ...
                        tablesToCheck: TenantTablesToCheck.All,
                        restoreAction: RestoreWrapper,
                        backupAction: BackupWrapper,
                        logger: _logger,
                        commandTimeoutSec: commandTimeoutSec,
                        maxAttempts: TenantSettings.ClampMigrationRetry(retryCount))
                        .ConfigureAwait(false);
            ...
            string databaseName, int? commandTimeoutSec = null)
        {
            ...
            try
            {
                ...
                using var dbContext = _dbContextFactory.CreateDbContext(databaseName, commandTimeoutSec);
            ...
            string databaseName)
        {
            ...
            catch (Exception ex)
            {
                ...
                return DbSchemaVersions.InitialSchemaVersion;
            }
        }
        ...
        private async Task TenantDbVersionFromMigrationsAsync(AppDbContext context, string databaseName)
        {
            try
            {
                ...
                var newVersion = DbSchemaVersions.ForMigration(latestMigration);
