...
public class Firma : BaseEntity
{
    ...
    [Required]
    [MaxLength(100)]
    public string KisaUnvani { get; set; } = string.Empty;
    ...
    public ICollection<MaliDonem> MaliDonemler { get; set; } = new List<MaliDonem>();
    ...
    {
        return $"{Id} {KisaUnvani} {TamUnvani} {YetkiliKisi} {Telefon1}".ToLower();
    }
}
