...
{
    /// <summary>
    /// Salt-okunur analiz sonucunun ortak iskeleti — DatabaseConnectionAnalysis ve
    /// DatabaseHealtyDiagReport tek kaynaktan (DbContextAnalysisExtensions) doldurulur.
    /// </summary>
    public abstract class DatabaseAnalysisResult : BaseDatabaseResult
    {
