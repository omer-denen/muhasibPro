...
namespace MuhasibPro.ViewModels.ViewModels.Sistem.MaliDonemler
{
    ...
    {
        public MaliDonemViewModel(ICommonServices commonServices, IMaliDonemService maliDonemService, ITenantSQLiteDatabaseService workflowService, MaliDonemListViewModel sharedMaliDonemList = null) : base(commonServices)
        {
