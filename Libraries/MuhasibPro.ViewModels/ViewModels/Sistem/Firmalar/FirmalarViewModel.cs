...
{
    public FirmalarViewModel(
        ICommonServices commonServices,
        IFirmaService firmaService,
        IFilePickerService filePickerService,
        IMaliDonemService maliDonemService,
        MaliDonemListViewModel sharedMaliDonemList = null) : base(commonServices)
    {
        ...
        // Dışarıdan paylaşılan MaliDonemList kullan, yoksa kendi oluştur
        MaliDonemList = sharedMaliDonemList ?? new MaliDonemListViewModel(commonServices, MaliDonemService);
    }
    ...
    public void Subscribe()
    {
        ...
        // MaliDonemList.Subscribe() burada YAPILMAZ — paylaşılan instance MaliDonemVM tarafından yönetilir
    }
    public void Unsubscribe()
    {
        ...
        // MaliDonemList.Unsubscribe() burada YAPILMAZ — paylaşılan instance MaliDonemVM tarafından yönetilir
    }
