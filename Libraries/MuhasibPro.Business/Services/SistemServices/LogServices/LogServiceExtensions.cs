...
namespace MuhasibPro.Business.Services.SistemServices.LogServices
{
    public static class LogServiceExtensions
    {
        ...
        public static async Task AppLogInformationAsync(this IAppLogService appLogService, string source, string action, string message, string description)
        { await appLogService.WriteAsync(LogType.Bilgi, source, action, message, description); }
        public static async Task AppLogErrorAsync(this IAppLogService appLogService, string source, string action, Exception exception)
        { await appLogService.WriteAsync(LogType.Hata, source, action, exception.Message, exception.ToString()); }
        public static async Task AppLogExceptionAsync(this IAppLogService appLogService, string source, string action, Exception exception)
        { await appLogService.WriteAsync(LogType.Hata, source, action, exception.Message, exception.ToString()); }
    }
}
